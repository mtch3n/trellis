...
type LintFinding struct {
	Kind string `json:"kind"` // template_violation, unknown_template, stub, broken_anchor, orphan, wrong_collection, bad_path, missing_artifact, unknown_field, deep_directory, long_directory_name, similar_directory
